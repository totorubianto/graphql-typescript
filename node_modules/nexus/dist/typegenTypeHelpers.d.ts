...
> = NexusGen extends infer GenTypes
  ? GenTypes extends GenTypesShape
    ...
    : false
  : false;
export declare type RootValue<TypeName extends string> = GetGen2<
  "rootTypes",
  TypeName
>;
export declare type RootValueField<
  TypeName extends string,
  FieldName extends string
> = GetGen3<"rootTypes", TypeName, FieldName>;
export declare type ArgsValue<
  TypeName extends string,
  FieldName extends string
...
export declare type ResultValue<
  ...
  FieldName extends string
> = GetGen3<"fieldTypes", TypeName, FieldName>;
export declare type NeedsResolver<
  TypeName extends string,
  FieldName extends string
