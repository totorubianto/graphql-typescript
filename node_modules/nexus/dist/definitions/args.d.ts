...
export declare type NexusArgConfigType<
  T extends GetGen<"allInputTypes", string>
> = T | AllNexusInputTypeDefs<T> | NexusWrappedType<AllNexusInputTypeDefs<T>>;
 ...
 */
export declare function arg<T extends GetGen<"allInputTypes", string>>(
  options: {
    type: NexusArgConfigType<T>;
  } & NexusArgConfig<T>
): NexusArgDef<any>;
export declare function stringArg(
  options?: ScalarArgConfig<string>
): NexusArgDef<any>;
export declare function intArg(
  options?: ScalarArgConfig<number>
): NexusArgDef<any>;
export declare function floatArg(
  options?: ScalarArgConfig<number>
): NexusArgDef<any>;
export declare function idArg(
  options?: ScalarArgConfig<string>
): NexusArgDef<any>;
export declare function booleanArg(
  options?: ScalarArgConfig<boolean>
): NexusArgDef<any>;
